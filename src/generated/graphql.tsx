...
export type PokemonsQuery = { __typename?: 'Query', pokemons?: { __typename?: 'PokemonList', nextOffset?: number | null, results?: Array<{ __typename?: 'PokemonItem', id?: number | null, name?: string | null, image?: string | null } | null> | null } | null };


export const PokemonsDocument = gql`
    query pokemons($offset: Int) {
  pokemons(offset: $offset, limit: 15) {
    nextOffset
    results {
      id
      name
